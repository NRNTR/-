var MAIN_DIMS = {"main_dims": {"N": {"name": "网络依存度", "sub": ["N_online", "N_disconnect", "N_info"]}, "E": {"name": "表达风格", "sub": ["E_express", "E_create", "E_voice"]}, "A": {"name": "攻击性", "sub": ["A_debate", "A_troll", "A_critic"]}, "Ac": {"name": "活跃度", "sub": ["Ac_social", "Ac_participate", "Ac_explore"]}, "So": {"name": "社交倾向", "sub": ["So_connect", "So_influence", "So_identity"]}}, "dim_labels": {"N": "网络依存", "E": "表达风格", "A": "攻击性", "Ac": "活跃度", "So": "社交倾向"}, "sub_labels": {"N_online": "在线时长", "N_disconnect": "断网焦虑", "N_info": "信息饥渴", "E_express": "表达欲", "E_create": "创作力", "E_voice": "发声意愿", "A_debate": "辩论倾向", "A_troll": "阴阳怪气", "A_critic": "批判精神", "Ac_social": "社交频率", "Ac_participate": "参与深度", "Ac_explore": "探索广度", "So_connect": "连接需求", "So_influence": "影响力欲", "So_identity": "身份认同"}};
